    ...
    <div>
        <header>
            <nav class="navbar navbar-expand-lg  fixed-top bg-white transparency border-bottom  border-light navbar-light"
                id="transmenu">
                <div class="container">
                    <a class="navbar-brand text-success " href="#header">
                        <i class="fa fa-leaf fa-2x"></i>&nbsp;YOUR COMPANY
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navcol-1">
                        <ul class="navbar-nav ms-auto">
                            <li class="nav-item"><a class="nav-link text-dark" href="#">First Item</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
            <div class="bg-secondary d-flex justify-content-center align-items-center"
                style="background:url('/assets/img/background.png'); background-size:cover; min-height: 100vh;">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-12 col-sm-8 col-md-6">
                            <div class="card bg-transparent" id="shadow">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control bg-transparent" id="basic-url"
